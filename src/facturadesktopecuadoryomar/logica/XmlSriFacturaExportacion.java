...
public class XmlSriFacturaExportacion extends XmlSriAbstratc {
  String correo;
  String cuenta;
  String direccion;
  
  public XmlSriFacturaExportacion(FacturacionIntermedia carga) throws Exception {
    super(carga);
  }
  ...
  public Documento getDocumento() throws ClaveAccesoException, SQLException, FormatoCargaException {
    ...
    doc.setIvaActual(Float.valueOf(this.configuracion.getIvaConf().floatValue()));
  ...
  public String getInfoDocumento() throws FormatoCargaException {
    StringBuilder sb = new StringBuilder();
    sb.append(XmlBuilder.createOpenTag("infoFactura", new Object[0]));
    ...
    String[] datosExportacion = this.carga.getListaInformacion().get(0).split("\\|");
    sb.append(XmlBuilder.createTag("comercioExterior", datosExportacion[28]));
    sb.append(XmlBuilder.createTag("incoTermFactura", datosExportacion[29]));
    sb.append(XmlBuilder.createTag("lugarIncoTerm", datosExportacion[30]));
    sb.append(XmlBuilder.createTag("paisOrigen", datosExportacion[31]));
    sb.append(XmlBuilder.createTag("puertoEmbarque", datosExportacion[32]));
    sb.append(XmlBuilder.createTag("puertoDestino", datosExportacion[33]));
    sb.append(XmlBuilder.createTag("paisDestino", datosExportacion[34]));
    sb.append(XmlBuilder.createTag("paisAdquisicion", datosExportacion[35]));
    ...
    sb.append(XmlBuilder.createTag("incoTermTotalSinImpuestos", datosExportacion[36]));
    ...
    sb.append(XmlBuilder.createTag("fleteInternacional", datosExportacion[37]));
    sb.append(XmlBuilder.createTag("seguroInternacional", datosExportacion[38]));
    sb.append(XmlBuilder.createTag("gastosAduaneros", datosExportacion[39]));
    sb.append(XmlBuilder.createTag("gastosTransporteOtros", datosExportacion[40]));
  ...
  private String generarImpuesto(String cod, String codPor, FacturacionIntermedia cc) {
    ...
    if (baseImp.doubleValue() > 0) {
      sb.append(XmlBuilder.createOpenTag("totalImpuesto", new Object[0]));
